...
var version= "3.4.1.2"; //maui chrome/safary webkit fullscreen compatible
...
(function($) {
  ...
  // $(window).on('orientationchange', function() {  //maui
  //   this.exitFullscreen();
